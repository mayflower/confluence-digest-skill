...
- **Mehrere** Treffer (mehrdeutig) oder **kein** Treffer → diese Person für diesen Lauf
  **überspringen** und einen kurzen Hinweis vermerken („Konnte ‚<name>' nicht eindeutig auflösen –
...
Hinweis zur Personen-Attribution: „Von <name> bearbeitet" meint die **verfolgte Person als
